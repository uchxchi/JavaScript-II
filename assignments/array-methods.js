...
// Problem 1
let emailAddress = [];
runners.forEach(item => emailAddress.push(item.email))
console.log(emailAddress);

// Problem 2
let nameOfCompany = [];
nameOfCompany = runners.map(item => item.company_name);
console.log(nameOfCompany);

// Problem 3

let donationProduct = [];
donationProduct = runners.reduce(function (accumulator, item) {
  return accumulator * item.donation;
},1)

console.log(donationProduct)